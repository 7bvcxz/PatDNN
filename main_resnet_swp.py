...
def ttest(args, model, device, test_loader, pattern_set, Z, Y, U, V):  # top-5 version
    model.eval()
    test_loss = 0
    loss_c = 0
    loss_z = 0
...
parser.add_argument('--connect_perc',  default=2, type=float,   help='connectivity pruning ratio')
